...
Account should handle withdrwal because Account and Main are supposed to handle different things. If Main handled all the functionality the file would be huge and overwhelming. Plus it creates issues with data storage ownership and organization. 
...
Step 3: OCP, LSP, ISP, and DIP

Step 4: Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, Dependency Inversion.
